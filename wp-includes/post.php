...
function create_post_type() {
  ...
  register_post_type( 'kistler_gallery', $args1);
  register_post_type( 'kistler_products', $args2);
  
  
	register_taxonomy_for_object_type('post_tag', 'kistler_gallery');
	register_taxonomy_for_object_type('post_tag', 'kistler_products');
	
	register_taxonomy_for_object_type('category', 'kistler_gallery');
	register_taxonomy_for_object_type('category', 'kistler_products');
